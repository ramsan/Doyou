...
ActiveRecord::Schema.define(:version => 20120814165150) do

  create_table "candidates", :force => true do |t|
    t.string   "name"
    t.string   "image"
    t.string   "google_thumb",       :limit => 2000
    t.string   "google_main",        :limit => 2000
    t.string   "google_page_url",    :limit => 2000
    t.string   "external_url",       :limit => 2000
  ...
  add_index "candidates", ["external_url"], :name => "index_candidates_on_external_url", :length => {"external_url"=>255}
  add_index "candidates", ["google_main"], :name => "index_candidates_on_google_main", :length => {"google_main"=>255}
  add_index "candidates", ["google_page_url"], :name => "index_candidates_on_google_page_url", :length => {"google_page_url"=>255}
  add_index "candidates", ["google_thumb"], :name => "index_candidates_on_google_thumb", :length => {"google_thumb"=>255}
  ...
  create_table "users", :force => true do |t|
    ...
    t.string   "fb_picture"
    t.integer  "notification_preferences",                  :default => 7
